    ...
    public partial class AdminAddProducts : UserControl
    {
                    ...
                    try
                    {
                        ...
                        using (SqlCommand selectPID = new SqlCommand(selectProdID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\Lenovo\Desktop\Stuff\BTQM\BoToQuanMoc\BoToQuanMoc\Products_Profile\"
        ...
        private void DataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(e.RowIndex != -1)
            {
                ...
                {
                    MessageBox.Show("Lỗi hình ảnh: " + ex, "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
        ...
        private void adminAddProducts_updateBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult check = MessageBox.Show("Ban chắc chắn muốn cập nhập mặt hàng với mã ID: " + adminAddProducts_id.Text.Trim() + "?"
                    ...
                    if(connect.State != ConnectionState.Open)
                    {
                        try
                        {
                            ...
                            using (SqlCommand updateD = new SqlCommand(updateData, connect))
                            {
                                ...
                                MessageBox.Show("Cập nhập hành công!", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                displayData();
        ...
        {
            {
                DialogResult check = MessageBox.Show("Bạn chắc chắn muốn xóa mặt hàng với ID: " + adminAddProducts_id.Text.Trim() + "?"
                    , "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void adminAddProducts_imageView_Click(object sender, EventArgs e)
        {
